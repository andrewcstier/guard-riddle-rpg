  ...
  if (!ready) {
    return (
      <div style={{
        ...
        <div style={{fontSize:9,marginBottom:16,color:"#a89cc8",maxWidth:400,lineHeight:"2"}}>
          This game uses Claude Opus to power NPC dialogue. You'll need an Anthropic API key to play.
        </div>
        <div style={{fontSize:7,color:"#8a7aaa",maxWidth:360,lineHeight:"2",marginBottom:16,textAlign:"left"}}>
